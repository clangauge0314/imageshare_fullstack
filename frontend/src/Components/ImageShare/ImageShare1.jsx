...
import image1 from "../../assets/20241023_153244.png";
    ...
    getRedirectResult(auth)
      .then((result) => {
        if (result && result.user) {
          ...
          user.getIdTokenResult().then((tokens) => {
          ...
          console.log("No Google login result");
        }
      })
      .catch((error) => {
